...
**Shiny**: **IA-SVA** is also available as an interactive web application (Shiny) [here](https://nlawlor.shinyapps.io/VIASVA/) and the source code for the app is available [here](https://github.com/nlawlor/iasva_shiny)
